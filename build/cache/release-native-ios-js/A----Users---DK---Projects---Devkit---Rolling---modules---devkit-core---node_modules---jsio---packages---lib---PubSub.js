71c34e5cde4fd65b98cf03d15ebbd376
jsio("from ..std.uuid import uuid");var ctx=jsio.__env.global,SLICE=Array.prototype.slice,Users_DK_Projects_Devkit_Rolling_modules_devkit_core_node_modules_jsio_packages_lib_PubSub=__class__;
exports=Users_DK_Projects_Devkit_Rolling_modules_devkit_core_node_modules_jsio_packages_lib_PubSub(function(){return this.init&&this.init.apply(this,arguments)},function(){this.init=function(){};this.publish=function(a){if(this._subscribers){var b=SLICE.call(arguments,1);if(this._subscribers.__any)for(var e=[a].concat(b),d=this._subscribers.__any.slice(0),c=0,f;f=d[c];++c)f.apply(ctx,e);if(!this._subscribers[a])return this;d=this._subscribers[a].slice(0);for(c=0;f=d[c];++c)f.apply(ctx,b)}return this};
this.subscribe=function(a,b,e){var d;2==arguments.length?d=b:(d=bind.apply(GLOBAL,SLICE.call(arguments,1)),d._ctx=b,d._method=e);var c=this._subscribers||(this._subscribers={});(c[a]||(c[a]=[])).push(d);return this};this.subscribeOnce=function(a,b,e){var d=arguments,c=bind(this,function(){this.unsubscribe(a,c);2==d.length?b.apply(GLOBAL,arguments):bind.apply(GLOBAL,SLICE.call(d,1)).apply(GLOBAL,arguments)});3<=d.length&&(c._ctx=b,c._method=e);return this.subscribe(a,c)};this.unsubscribe=function(a,
b,e){if(!this._subscribers||!this._subscribers[a])return this;for(var a=this._subscribers[a],d=0,c;c=a[d];++d)(c==b||c._ctx==b&&(!e||c._method==e))&&a.splice(d--,1);return this};this.listeners=function(a){this._subscribers=this._subscribers?this._subscribers:{};return this.hasOwnProperty.call(this._subscribers,a)?this._subscribers[a]:this._subscribers[a]=[]};this.addListener=this.on=function(a,b){this.listeners(a).length+1>this._maxListeners&&0!==this._maxListeners&&"undefined"!==typeof console&&
